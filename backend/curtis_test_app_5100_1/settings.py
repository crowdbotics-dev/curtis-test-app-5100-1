"""
Django settings for curtis_test_app_5100_1 project.
...
ROOT_URLCONF = 'curtis_test_app_5100_1.urls'
...
WSGI_APPLICATION = 'curtis_test_app_5100_1.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "curtis test app 5100 Support <support@curtis-test-app-5100-1.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "curtis_test_app_5100_1 API",
    "DESCRIPTION": "API documentation for curtis_test_app_5100_1 App",
    "VERSION": "v1",
}
